...
- Wilcoxon signed-rank test 结果：
  ...
  - `reduction_time` vs `MCB-AR`：p=0.359375，Ours=0.032578，Baseline=0.040344。
...
- `Ours` 在 9 个任务点上的平均纯约简时间：0.032578 s。
- `MCB-AR` 在 9 个任务点上的平均纯约简时间：0.040344 s。
- `Ours` 在 9 个任务点上的平均选择总开销：0.032579 s。
- `MCB-AR` 在 9 个任务点上的平均选择总开销：0.040344 s。
